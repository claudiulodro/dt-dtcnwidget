<?php
/*----------------------------------------
$Id: index.php,v 1.4 2005/04/24 04:43:14 migurski Exp $
...
rss.php - exports public items as HTML
----------------------------------------*/
    ...
    $page->assign('feed_url',"http://{$_SERVER['HTTP_HOST']}".str_replace(basename($_SERVER['REQUEST_URI']), 'rss.php', $_SERVER['REQUEST_URI']));
    $page->assign('now', gmmktime());
    
    $page->display('page-html.tpl');
